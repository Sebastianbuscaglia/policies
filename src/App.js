...
function App() {
  ...
  useEffect(() => {
    ...
    const updatedText = `Last updated: ${month} ${year}`;
    setLastUpdatedText(updatedText);
  }, []);
    ...
    <div className="App">
      <section class="main">
        <div class="tab-content translations-content-item en visible" id="en">
          <h1>Privacy Policy for Le Park App</h1>
          <p>{lastUpdatedText}</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                "We", "Us" or "Our" in this Agreement) refers to Magnetic Cash
                TM., 10524 Moss Park RDSuite (282-204) Orlando 32832.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                Service such as a cellphone or a digital tablet.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            ...
            <li>
              saved personal data can be viewed in the "Info" tab within the
              App.
            </li>
          </ul>
          ...
          <p>
            any user can request their data to be deleted by sending an email to
            direccion@magneticash.com, and our staff will delete your data, this
            means the deletion of the account permanently.
          </p>
          ...
          <ul>
            <li>By email: direccion@magneticash.com</li>
          </ul>
        </div>
      </section>
    </div>
